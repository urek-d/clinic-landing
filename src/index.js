...
import MedecineGeneraleDetails from "./elements/MedecineGeneraleDetails";
import OphtalmologieDetails from "./elements/OphtalmologieDetails";
import StomatologieDetails from "./elements/StomatologieDetails";
import ORLDetails from "./elements/ORLDetails";
import GynecologieDetails from "./elements/GynecologieDetails";
import CardiologieDetails from "./elements/CardiologieDetails";
import LaboratoireDetails from "./elements/LaboratoireDetails";
            ...
            <BrowserRouter basename={'/'}>
                <PageScrollTop>
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL}/`} component={HomeParticles}/>
                        ...
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/médecine-générale`} component={MedecineGeneraleDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/ophtalmologie`} component={OphtalmologieDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/stomatologie`} component={StomatologieDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/orl`} component={ORLDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/gynécologie`} component={GynecologieDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/cardiologie`} component={CardiologieDetails}/> 
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details/laboratoire`} component={LaboratoireDetails}/>   
